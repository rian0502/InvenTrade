    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <a href="{{ route('conversion.index') }}" class="btn btn-danger"><span class="left badge"><i
                            class="fas fa-arrow-left"></i></span> Back</a>
            </div>
            <form method="POST" action="{{ route('conversion.update', $conversion->id) }}">
                @method('PUT')
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('conversion_name') is-invalid @enderror"
                                    ...
                                    value="{{ old('conversion_name', $conversion->conversion_name) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="conversion_valueconversion_value" class="form-label">Value</label>
                                <input type="text" class="form-control @error('conversion_value') is-invalid @enderror"
                                    ...
                                    value="{{ old('conversion_value', $conversion->conversion_value) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="from_unit_id"
                                    ...
                                    @foreach ($uoms as $uom)
                                        <option value="{{ $uom->id }}"
                                            {{ old('from_unit_id', $conversion->from_unit_id) == $uom->id ? 'selected' : '' }}>
                                            {{ $uom->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="to_unit_id"
                                    ...
                                    @foreach ($uoms as $uom)
                                        <option value="{{ $uom->id }}"
                                            {{ old('to_unit_id', $conversion->to_unit_id) == $uom->id ? 'selected' : '' }}>
                                            {{ $uom->name }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="form-group">
                        <div class="icheck-primary d-inline">
                            <input name="is_active" type="checkbox" id="is_active"
                                {{ old('is_active', $conversion->is_active) ? 'checked' : '' }}>
                            <label for="is_active">
                                Status
                            </label>
                        </div>
