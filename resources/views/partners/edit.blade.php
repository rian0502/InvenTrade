                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('contact_person') is-invalid @enderror"
                                    id="contact_person" aria-describedby="contact_person" name="contact_person"
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                    id="phone" aria-describedby="phone" name="phone"
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <textarea aria-describedby="description" class="form-control  @error('description') is-invalid @enderror"
                                    id="description" rows="3" name="description">{{ old('description', $partner->description) }}</textarea>
                                @error('description')
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <textarea aria-describedby="address" class="form-control  @error('address') is-invalid @enderror" id="address"
                                    rows="3" name="address">{{ old('address', $partner->address) }}</textarea>
                                @error('address')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control @error('is_supplier') is-invalid @enderror" id="is_supplier"
                                    name="is_supplier">
                                    <option value="1"
                                        {{ old('is_supplier', $partner->is_supplier) == 'vendor' ? 'selected' : '' }}>
                                        Vendor
                                    </option>
                                    <option value="0"
                                        {{ old('is_supplier', $partner->is_supplier) == 'customer' ? 'selected' : '' }}>
                                        Customer</option>
                                </select>
                                @error('is_supplier')
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                ...
                                <input type="checkbox" class="form-check-input" id="exampleCheck1" name="is_active"
                                    value="1" {{ old('is_active', $partner->is_active) == 1 ? 'checked' : '' }}>
